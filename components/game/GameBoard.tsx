      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 transition-colors duration-300">
        ...
        <div className="pt-14">
          <div className="max-w-4xl mx-auto p-4">
            ...
            {/* Movie Still - positioned to work well with transparent navbar */}
            <div className="mb-6">
              <div className="relative bg-black rounded-2xl overflow-hidden shadow-xl border border-gray-200/50 dark:border-gray-700/50">
                ...
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 border border-gray-200/50 dark:border-gray-700/50">
                  ...
                  <div className="grid gap-3">
                    ...
                    {dailyChallenge.hints.level2.data.year && (
                      <div className="flex items-center gap-3 bg-white/60 dark:bg-gray-700/60 backdrop-blur-sm rounded-lg p-3">
            ...
            {!gameState.completed && gameState.currentHintLevel < 3 && (
              <div className="text-center mb-6">
                <button
                  onClick={handleSkip}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:bg-white/90 dark:hover:bg-gray-700/90 text-gray-700 dark:text-gray-200 rounded-xl transition-all border border-gray-200/50 dark:border-gray-700/50 font-medium"
                >
              ...
              <div className="mt-8">
                ...
                <div className="space-y-3">
                  {gameState.guesses.map((guess, index) => (
                    <div
                      key={guess.id}
                      className={`flex items-center gap-4 p-4 rounded-xl border-2 transition-all duration-300 backdrop-blur-sm ${
                        guess.correct 
                          ? 'bg-green-50/80 dark:bg-green-900/20 border-green-300 dark:border-green-700 shadow-sm' 
